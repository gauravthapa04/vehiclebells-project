              ...
              <Col lg={8}>
                <Row>
                  <Col lg={4}>
                    <div className="footer_block wow fadeInUp">
                        ...
                        <ul>
                            ...
                            <li><Link href="">Resource Hub</Link></li>
                  ...
                  <div className="footer_block wow fadeInUp">
                      <h4>Solutions</h4>
                      <ul>
                          <li><Link href="">Mileage Tracking</Link></li>
                          <li><Link href="">Team Management</Link></li>
                          <li><Link href="">Route ATM locations</Link></li>
                          <li><Link href="">Route Petrol pumps locations</Link></li>
                          <li><Link href="">Calculate Trip expenses</Link></li>
                      </ul>
                  </div>                    
                  </Col>
                  <Col lg={4}>
                  <div className="footer_block wow fadeInUp">
                      ...
                      <ul>
                          <li>
                              <Link href="mailto:support@vehiclebells.com">
